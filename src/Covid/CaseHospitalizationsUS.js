...
import { popdata } from "./CaseExpected";
...
class CaseHospitalizationsUS extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const ilikeiData = this.state.ilikeiData.map(([x, y]) => [
      ((x - this.state.lowDate) / this.state.xAxis) *
        this.props.lastWidth *
        0.9,
      ((y - 0) / this.state.highDischarges) * 150
    ]);
            ...
            <div style={{ width: "max-content" }}>
              <div
                style={{
                  width: "5px",
                  height: "5px",
                  backgroundColor: "rgb(100,140,200)"
                }}
              />
              vaxxed&nbsp;
            </div>
...
export default CaseHospitalizationsUS;
