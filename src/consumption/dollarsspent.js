...
class DollarsSpent extends React.Component {
  state = {};
      ...
      >
        {this.state.giveUp ? (
          ...
          <iframe
            ...
            loading="lazy"
            title="total spent"
            src={`https://fred.stlouisfed.org/graph/graph-landing.php?g=o0Lb&width=${
              width - 20
            }&height=300`}
            style={{
              border: "none",
